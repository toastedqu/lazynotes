...
First, it's dynamic, so everything is always changing, so no state is permanent. You no longer see objects as static states but dynamic processes. When computation forces you to be attracted to her beauty, it takes one step further to let you see her rough life trajectory: fetus, birth, growth, adulthood, aging, death, decomposition. Understanding impermanence, you struggle to get yourself to be attached to anything even if you try, unless you genuinely love the entire process from its creation to its destruction.
